                                    ...
                                    Text(
                                      /*DateTime.now().difference(DateTime.tryParse
                                        (video_data[index]["created_at"])).inHours.toString()
                                          +" hr ago",*/
                                      DateTime.now().difference(DateTime.tryParse(
                                          video_data[index]["created_at"])).inHours <= 24 ?
                                      DateTime.now().difference(DateTime.tryParse(
                                          video_data[index]["created_at"])).inHours.toString()+" hr ago" :
                                      DateTime.now().difference(DateTime.tryParse(
                                          video_data[index]["created_at"])).inDays.toString()
                                          +" days ago",
                                      style: TextStyle(
                                          fontFamily: "SFPro",
                                          fontWeight: FontWeight.w500,
